...
const connection = (0, vscode_languageserver_1.createConnection)();
(0, lightning_lsp_common_1.interceptConsoleLogger)(connection);
...
connection.onInitialize(async (params) => {
    ...
    try {
        ...
        if (context.type === shared_1.WorkspaceType.CORE_PARTIAL) {
            await (0, tern_server_1.startServer)(path.join(workspaceRoots[0], '..'), path.join(workspaceRoots[0], '..'));
        }
        else {
            await (0, tern_server_1.startServer)(workspaceRoots[0], workspaceRoots[0]);
        }
        context.configureProject();
        const auraIndexer = new indexer_1.default(context);
        (0, auraTags_1.setIndexer)(auraIndexer);
        ...
        startIndexing();
        htmlLS = (0, lightning_lsp_common_1.getLanguageService)();
        htmlLS.addTagProvider((0, auraTags_1.getAuraTagProvider)());
