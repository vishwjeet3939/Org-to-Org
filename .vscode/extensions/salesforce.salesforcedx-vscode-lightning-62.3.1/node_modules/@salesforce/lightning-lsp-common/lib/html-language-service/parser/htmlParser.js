...
class Node {
    ...
    findNodeBefore(offset) {
        let idx = (0, arrays_1.findFirst)(this.children, c => offset <= c.start) - 1;
        if (idx >= 0) {
...
exports.Node = Node;
function parse(text) {
    let scanner = (0, htmlScanner_1.createScanner)(text);
    ...
    while (token !== htmlLanguageTypes_1.TokenType.EOS) {
        switch (token) {
            ...
            case htmlLanguageTypes_1.TokenType.StartTagClose:
                ...
                if (curr.tag && (0, htmlTags_1.isEmptyElement)(curr.tag) && curr.parent) {
                    curr.closed = true;
                    curr = curr.parent;
                }
                break;
