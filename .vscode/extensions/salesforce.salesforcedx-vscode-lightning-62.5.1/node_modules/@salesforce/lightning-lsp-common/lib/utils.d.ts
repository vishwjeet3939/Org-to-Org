...
export declare function containsDeletedLwcWatchedDirectory(context: WorkspaceContext, changes: FileEvent[]): Promise<boolean>;
...
export declare function getBasename(textDocument: TextDocument): string;
