...
function format(document, range, options) {
    ...
    let result = (0, beautify_html_1.html_beautify)(value, htmlOptions);
    if (initialIndentLevel > 0) {
        let indent = options.insertSpaces ? (0, strings_1.repeat)(' ', tabSize * initialIndentLevel) : (0, strings_1.repeat)('\t', initialIndentLevel);
        result = result.split('\n').join('\n' + indent);
